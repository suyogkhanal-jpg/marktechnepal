  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between" style={{ marginBottom: '3mm' }}>
        ...
        {/* Address & Contact */}
        <div className="text-right" style={{ fontSize: '9pt', lineHeight: 1.3, flexShrink: 0, width: '42mm' }}>
      ...
      <div style={{ marginBottom: '3mm', fontSize: '11pt' }}>
        ...
        <div className="flex items-baseline">
          ...
          <span 
            ...
            style={{ ...dataFont, width: '35mm', paddingBottom: '1px', minHeight: '5mm' }}
          >
            {primaryReceipt.customer_phone}
          </span>
          <span style={{ ...labelFont, marginLeft: '5mm', width: '8mm', flexShrink: 0 }}>PW:</span>
          <span 
            className="flex-1 border-b border-black" 
            style={{ ...dataFont, paddingBottom: '1px', minHeight: '5mm' }}
          >
      ...
      >
        <thead>
          <tr style={{ backgroundColor: '#f0f0f0' }}>
            ...
            <th style={{ ...labelFont, border: '1px solid #000', padding: '2mm 1mm', textAlign: 'center', width: '38mm' }}>Problem</th>
        ...
        <tbody>
          {receipts.map((receipt, index) => (
            <tr key={receipt.id}>
              ...
              <td style={{ ...dataFont, border: '1px solid #000', padding: '2mm 1mm', verticalAlign: 'top', textTransform: 'capitalize' }}>
                {receipt.device_type}
      ...
      {/* Service Description */}
      <div className="text-center" style={{ fontSize: '9pt', lineHeight: 1.3, marginBottom: '2mm' }}>
        <p style={{ margin: 0 }}>Laptop, Desktop, Projector, Printer and all kinds of computer</p>
        <p style={{ margin: 0 }}>Accessories maintenance and sales</p>
      </div>
