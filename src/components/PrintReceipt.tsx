    ...
    <div className="receipt-print bg-white text-black font-sans" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex-shrink-0">
          <img src={marktechLogo} alt="MarkTech Nepal" className="h-16 w-auto" />
        </div>
        
        {/* Title - Center */}
        <div className="text-center flex-1 px-4">
          <h1 className="font-bold tracking-wide" style={{ fontSize: '32px', letterSpacing: '2px' }}>
            MARKTECH NEPAL
          </h1>
        ...
        {/* Address - Top Right */}
        <div className="text-right flex-shrink-0" style={{ fontSize: '12px' }}>
      ...
      <div className="mb-3">
        <span style={{ fontSize: '14px' }}>Receipt No.</span>
        <span className="font-bold ml-2" style={{ fontSize: '20px' }}>{receiptNumberDisplay}</span>
      </div>

      {/* Customer Info Section */}
      <div className="mb-4" style={{ fontSize: '14px' }}>
        <div className="flex items-baseline mb-2">
          <span className="font-medium" style={{ minWidth: '120px' }}>Customer Name:</span>
          <span className="flex-1 border-b border-dotted border-black ml-1 pb-0.5">{primaryReceipt.customer_name}</span>
        </div>
        <div className="flex items-baseline">
          <span className="font-medium" style={{ minWidth: '70px' }}>Contact:</span>
          <span className="flex-1 border-b border-dotted border-black ml-1 pb-0.5">{primaryReceipt.customer_phone}</span>
          <span className="font-medium ml-4" style={{ minWidth: '40px' }}>PW:</span>
          <span className="w-32 border-b border-dotted border-black ml-1 pb-0.5">{firstPassword}</span>
        </div>
      </div>

      {/* Devices Table */}
      <table className="w-full border-collapse border border-black mb-4" style={{ fontSize: '13px' }}>
        <thead>
          <tr className="bg-white">
            <th className="border border-black p-2 text-left font-semibold" style={{ width: '35px' }}>S.N</th>
            ...
            <th className="border border-black p-2 text-left font-semibold" style={{ width: '90px' }}>Model NO.</th>
            <th className="border border-black p-2 text-left font-semibold" style={{ width: '90px' }}>Serial No.</th>
          </tr>
        </thead>
        <tbody>
      ...
      {/* Service Description - Larger font */}
      <div className="text-center mb-3" style={{ fontSize: '14px' }}>
        <p className="font-medium">
          Laptop, Desktop, Projector, Printer and all kinds of computers – Accessories maintenance and sales
        </p>
      </div>

      {/* Terms & Conditions - Larger Nepali text */}
      ...
      {/* Signature Section - Mandatory, visually separated, only MKTN */}
      <div className="border-t border-gray-400 pt-8 mt-4">
        <div className="flex justify-center">
          <div className="text-center">
            <div className="w-52 border-b border-black mb-2" style={{ height: '55px' }}></div>
            <span className="font-medium" style={{ fontSize: '14px' }}>MKTN</span>
          </div>
        </div>
      </div>
    </div>
